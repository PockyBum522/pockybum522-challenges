...
internal static class Program
{
    ...
    public static async Task Main()
    {
        ...
        foreach (var line in rawLines)
        {
            ...
            var longSpringLine = $"{springLine}?{springLine}?{springLine}?{springLine}?{springLine}";
            var longNumbersLine = $"{numbersLine},{numbersLine},{numbersLine},{numbersLine},{numbersLine}";
            
            var numbers = longNumbersLine.SplitGeneric<int>(",");
            ...
            var unknownChars = CountUnknownCharacters(line);

            var testOne = unknownChars * validPermutations;
            
            
            
            
            _logger.Information("Line: {Line} has {Count} valid permutations. Test ans: {Answer}", 
                line, validPermutations, testOne);
    ...
    private static int CountUnknownCharacters(string line)
    {
